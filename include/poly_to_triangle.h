...
*@param[in] poPolygon: polygon geometry to triangulate.
*@param[out] li_vector: empty vector that will be filled with created Triangle objects.
*@param[in] type: Triangle type.
*/
